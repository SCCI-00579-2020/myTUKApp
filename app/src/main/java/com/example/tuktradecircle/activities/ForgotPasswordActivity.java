...
public class ForgotPasswordActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        editTextPwdResetEmail= findViewById(R.id.editText_reset_email);
        ...
        buttonPwdReset.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(TextUtils.isEmpty(email)){
                    ...
                    editTextPwdResetEmail.setError("Email is empty");
                    editTextPwdResetEmail.requestFocus();
                } else if (!Patterns.EMAIL_ADDRESS.matcher(email).matches()) {
                    Toast.makeText(ForgotPasswordActivity.this, "Enter valid email", Toast.LENGTH_SHORT).show();
                    editTextPwdResetEmail.setError("enter email that is registered");
                    editTextPwdResetEmail.requestFocus();
                }else {
        ...
        authProfile.sendPasswordResetEmail(email).addOnCompleteListener(new OnCompleteListener<Void>() {
            ...
            public void onComplete(@NonNull Task<Void> task) {
                if (task.isSuccessful()){
                    Toast.makeText(ForgotPasswordActivity.this, "Check your inbox or spam for the reset link", Toast.LENGTH_SHORT).show();
